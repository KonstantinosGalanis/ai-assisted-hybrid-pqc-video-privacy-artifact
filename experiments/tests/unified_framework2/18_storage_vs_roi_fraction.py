...
"""
18_chacha_storage_vs_roi_fraction.py

Storage overhead vs ROI density test for the ChaCha20-Poly1305 payload branch.
It groups one or more dataset folders by mean ROI fraction and reports plain video,
ChaCha ROI package, sidecar, payload, manifest, and optional baseline sizes.
"""
...
def main() -> None:
    ...
    for ds in args.datasets:
        ...
        row = {
            ...
            "chacha_roi_video_size_bytes": cipher_size,
            ...
            **rf,
            ...
            "detected_chacha_roi_baseline_size_bytes": file_size(optional.get("chacha_roi")),
            "assets": assets,
    ...
    report = {"focus": "ChaCha storage overhead vs ROI fraction", "roi_area_method": args.roi_area_method, "groups": group_summary, "rows": rows}

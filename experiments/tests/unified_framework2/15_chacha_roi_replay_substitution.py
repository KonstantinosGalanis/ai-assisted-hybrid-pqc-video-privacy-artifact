...
"""
15_chacha_roi_replay_substitution.py

Replay/substitution tests for the ChaCha20-Poly1305 payload branch. It deliberately
moves or substitutes encrypted ROI payload records across frame/object contexts and
...
def run_decrypt(args, payload_path: str, manifest_path: str, out_path: str) -> Tuple[bool, str, str, int]:
    cmd = [
        ...
        "--video_preview_mode", "chacha", "--audio_preview_mode", "chacha",
    ]
...
def main() -> None:
    ap = argparse.ArgumentParser(description="ChaCha20-Poly1305 ROI replay/substitution rejection tests.")
    ...
    report = {
        "focus": "ChaCha20-Poly1305 ROI replay/substitution rejection using manifest, AEAD AAD, and payload HMAC binding.",
